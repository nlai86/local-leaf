    ...
    <section className="py-24 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
          Join hundreds of Canadian homeowners who've discovered the joy of a
          professionally maintained lawn. Your free quote is just a click away —
          and there's absolutely no obligation.
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
          <button className="w-full sm:w-auto bg-primary hover:bg-primary-light text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
